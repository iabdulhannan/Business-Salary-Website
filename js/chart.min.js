        ...
        1: [function (t, e, n) {
                ...
                if (t) {
                    ...
                    if (n) {
                        var i = parseFloat(n[4]), a = b(parseInt(n[1]), 0, 360), o = b(parseFloat(n[2]), 0, 100),
                            r = b(parseFloat(n[3]), 0, 100), l = b(isNaN(i) ? 1 : i, 0, 1);
                        return [a, o, r, l]
                    }
                }
            }
            ...
            e.exports = function (t) {
                ...
                t.defaults.bar = {
                    ...
                    dataElementType: t.elements.Rectangle, initialize: function () {
                        var e, n = this;
                        ...
                        var a = this, o = a.chart, r = a.getMeta(), l = a.getDataset(), s = t.custom || {},
                        ...
                        var e, n, i = this, a = i.chart, o = i.getIndexScale(), r = o.options.stacked,
                            l = void 0 === t ? a.data.datasets.length : t + 1, s = [];
                        ...
                        var t = this, n = t.getIndexScale(), i = n.options, a = t.getStackCount(),
                            o = n.isHorizontal() ? n.width : n.height, r = o / n.ticks.length,
                            l = r * i.categoryPercentage, s = l / a, u = s * i.barPercentage;
                        ...
                        var n, i, a, o, r, l, s = this, u = s.chart, d = s.getMeta(), c = s.getValueScale(),
                            h = u.data.datasets, f = Number(h[t].data[e]), g = c.options.stacked, p = d.stack, m = 0;
                        if (g || void 0 === g && void 0 !== p) for (n = 0; n < t; ++n) i = u.getDatasetMeta(n), i.bar && i.stack === p && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && (a = Number(h[n].data[e]), (f < 0 && a < 0 || f >= 0 && a > 0) && (m += a));
                        ...
                        var i = this, a = n.scale, o = i.chart.isCombo, r = i.getStackIndex(t),
                        ...
                        var t, n = this, i = n.chart, a = n.getMeta().data, o = n.getDataset(), r = a.length, l = 0;
                ...
                t.defaults.bubble = {
                    ...
                    dataElementType: t.elements.Point, update: function (t) {
                        ...
                        var o = this, r = o.getMeta(), l = o.getScaleForId(r.xAxisID), s = o.getScaleForId(r.yAxisID),
                            u = n.custom || {}, d = o.getDataset(), c = d.data[i], h = o.chart.options.elements.point,
                            f = o.index;
                        e.extend(n, {
                            _xScale: l,
                            _yScale: s,
                        ...
                        var a = i.chart.data.datasets[n._datasetIndex], o = n._index, r = n.custom || {}, l = n._model;
                ...
                n.doughnut = {
                        ...
                        labels: {
                            generateLabels: function (t) {
                                ...
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var o = t.getDatasetMeta(0), r = n.datasets[0], l = o.data[a],
                                        s = l && l.custom || {}, u = e.getValueAtIndexOrDefault,
                    ...
                    tooltips: {
                        callbacks: {
                            title: function () {
                                ...
                                var i = n.labels[t.index], a = ": " + n.datasets[t.datasetIndex].data[t.index];
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, getRingIndex: function (t) {
                        ...
                        var n = this, i = n.chart, a = i.chartArea, o = i.options, r = o.elements.arc,
                            l = a.right - a.left - r.borderWidth, s = a.bottom - a.top - r.borderWidth,
                            u = Math.min(l, s), d = {x: 0, y: 0}, c = n.getMeta(), h = o.cutoutPercentage,
                            f = o.circumference;
                        if (f < 2 * Math.PI) {
                        ...
                        var a = this, o = a.chart, r = o.chartArea, l = o.options, s = l.animation,
                            ...
                            p = i && s.animateScale ? 0 : a.innerRadius, m = i && s.animateScale ? 0 : a.outerRadius,
            ...
            e.exports = function (t) {
                ...
                t.defaults.line = {
                    ...
                    datasetElementType: t.elements.Line, dataElementType: t.elements.Point, update: function (t) {
                        var i, a, o, r = this, l = r.getMeta(), s = l.dataset, u = l.data || [], d = r.chart.options,
                        ...
                        var a, o, r = this, l = r.getMeta(), s = t.custom || {}, u = r.getDataset(), d = r.index,
                        ...
                        if (u.options.stacked) {
                            for (i = 0; i < n; i++) if (a = l.data.datasets[i], o = l.getDatasetMeta(i), "line" === o.type && o.yAxisID === u.id && l.isDatasetVisible(i)) {
                        ...
                        var e, i, a, o, r, l = this, s = l.getMeta(), u = l.chart.chartArea, d = s.data || [];
            ...
            e.exports = function (t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legend: {
                        labels: {
                            generateLabels: function (t) {
                                var n = t.data;
                                return n.labels.length && n.datasets.length ? n.labels.map(function (i, a) {
                                    var o = t.getDatasetMeta(0), r = n.datasets[0], l = o.data[a], s = l.custom || {},
                    ...
                    dataElementType: t.elements.Arc, linkScales: e.noop, update: function (t) {
                        var n = this, i = n.chart, a = i.chartArea, o = n.getMeta(), r = i.options, l = r.elements.arc,
                        ...
                        var b = l.startAngle, x = t.hidden ? 0 : u.getDistanceFromCenterForValue(r.data[n]),
                ...
                t.defaults.radar = {
                    ...
                    update: function (t) {
                        var n = this, i = n.getMeta(), a = i.dataset, o = i.data, r = a.custom || {},
                            l = n.getDataset(), s = n.chart.options.elements.line, u = n.chart.scale;
                    ...
                    updateElement: function (t, n, i) {
                        var a = this, o = t.custom || {}, r = a.getDataset(), l = a.chart.scale,
                            s = a.chart.options.elements.point, u = l.getPointPositionForValue(n, r.data[n]);
                    ...
                    if (!(isNaN(i) || i <= 0)) {
                        switch (n) {
                            ...
                            case"rect":
                                ...
                                break;
                            case"rectRounded":
                                var h = i / Math.SQRT2, f = a - h, g = o - h, p = Math.SQRT2 * i;
            ...
            e.exports = function (t) {
                ...
                var a = t.helpers, o = t.plugins, r = t.platform;
                t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                    construct: function (n, i) {
                        ...
                        var e = this, n = e.options, i = e.canvas, r = n.maintainAspectRatio && e.aspectRatio || null,
                            l = Math.floor(a.getMaximumWidth(i)), s = Math.floor(r ? l / r : a.getMaximumHeight(i));
                        // if ((e.width !== l || e.height !== s) && (i.width = e.width = l, i.height = e.height = s, i.style.width = l + "px", i.style.height = s + "px", a.retinaScale(e), !t)) {
                        if ((e.width !== l || e.height !== s) && (i.width = e.width = l, i.height = e.height = s, a.retinaScale(e), !t)) {
                        ...
                        var e = this, n = e.options, o = e.scales = {}, r = [];
                        n.scales && (r = r.concat((n.scales.xAxes || []).map(function (t) {
                            ...
                            var r = n.options, l = a.getValueOrDefault(r.type, n.dtype),
                                s = t.scaleService.getScaleConstructor(l);
                            if (s) {
                                i(r.position) !== i(n.dposition) && (r.position = n.dposition);
                                var u = new s({id: r.id, options: r, ctx: e.ctx, chart: e});
                        ...
                        if (a.each(e.data.datasets, function (a, o) {
                            ...
                            if (r.type || (r.type = a.type || e.config.type), n.push(r.type), r.controller) r.controller.updateIndex(o); else {
                        ...
                        }, e), n.length > 1) for (var o = 1; o < n.length; o++) if (n[o] !== n[o - 1]) {
                            e.isCombo = !0;
                            break
                        }
                        return i
                        ...
                        if (o.notify(i, "beforeRender") !== !1) {
                            var r = i.options.animation, l = function (t) {
                            ...
                            if (r && ("undefined" != typeof e && 0 !== e || "undefined" == typeof e && 0 !== r.duration)) {
                                var s = new t.Animation({
                                    ...
                                    easing: r.easing,
                                    render: function (t, e) {
                                        var n = a.easingEffects[e.easing], i = e.currentStep, o = i / e.numSteps;
                                        t.draw(n(o), o, i)
                                    },
            ...
            e.exports = function (t) {
                ...
                var i = t.helpers, a = ["push", "pop", "shift", "splice", "unshift"];
            ...
            e.exports = function (t) {
                function e(t, e, n, a) {
                    ...
                    for (o = 0, r = g.length; o < r; ++o) if (l = g[o], d = n[l], e.hasOwnProperty(l) || (e[l] = d), s = e[l], s !== d && "_" !== l[0]) {
                        if (t.hasOwnProperty(l) || (t[l] = s), u = t[l], c = typeof d, c === typeof u) if ("string" === c) {
                ...
                t.elements = {}, t.Element = function (t) {
                    ...
                    initialize: function () {
                        ...
                        var n = this, i = n._model, a = n._start, o = n._view;
            ...
            e.exports = function (t) {
                ...
                o.each = function (t, e, n, i) {
                    var a, r;
                    if (o.isArray(t)) if (r = t.length, i) for (a = r - 1; a >= 0; a--) e.call(n, t[a], a); else for (a = 0; a < r; a++) e.call(n, t[a], a); else if ("object" == typeof t) {
                        var l = Object.keys(t);
                    ...
                    return o.each(Array.prototype.slice.call(arguments, 1), function (e) {
                        o.each(e, function (e, i) {
                            var a = n.hasOwnProperty(i), r = a ? n[i] : {};
                    ...
                    for (e = 0; e < l; ++e) if (i = r[e], !i.model.skip) {
                ...
                o.requestAnimFrame = function () {
                    ...
                    var e = t.parentNode, n = parseInt(o.getStyle(e, "padding-left"), 10),
                        i = parseInt(o.getStyle(e, "padding-right"), 10), a = e.clientWidth - n - i,
                        r = o.getConstraintWidth(t);
                    return isNaN(r) ? a : Math.min(a, r)
                }, o.getMaximumHeight = function (t) {
                    var e = t.parentNode, n = parseInt(o.getStyle(e, "padding-top"), 10),
                    ...
                    if (1 !== e) {
                        var n = t.canvas, i = t.height, a = t.width;
            ...
            e.exports = function (t) {
                ...
                function n(t, e) {
                    ...
                    for (i = 0, o = l.length; i < o; ++i) if (t.isDatasetVisible(i)) for (n = t.getDatasetMeta(i), a = 0, r = n.data.length; a < r; ++a) {
                        var s = n.data[a];
                        s._view.skip || e(s)
                    }
                }
                ...
                function a(t, e, i, a) {
                    var o = Number.POSITIVE_INFINITY, l = [];
                    return a || (a = r.distanceBetweenPoints), n(t, function (t) {
                        if (!i || t.inRange(e.x, e.y)) {
                            var n = t.getCenterPoint(), r = a(e, n);
                ...
                function o(t, n, o) {
                    var r = e(n, t), l = function (t, e) {
                        return Math.abs(t.x - e.x)
                    }, s = o.intersect ? i(t, r) : a(t, r, !1, l), u = [];
                    return s.length ? (t.data.datasets.forEach(function (e, n) {
                        if (t.isDatasetVisible(n)) {
                            var i = t.getDatasetMeta(n), a = i.data[s[0]._index];
                ...
                t.Interaction = {
                    modes: {
                        single: function (t, i) {
                        ...
                        }, label: o, index: o, dataset: function (t, n, o) {
                            var r = e(n, t), l = o.intersect ? i(t, r) : a(t, r, !1);
                            ...
                            var o = e(n, t), r = a(t, o, i.intersect);
                            return r.length > 1 && r.sort(function (t, e) {
                                var n = t.getArea(), i = e.getArea(), a = n - i;
            ...
            e.exports = function (t) {
                ...
                t.layoutService = {
                    defaults: {}, addBox: function (t, e) {
                        ...
                        if (t) {
                            var d = t.options.layout, c = d ? d.padding : null, h = 0, f = 0, g = 0, p = 0;
                            isNaN(c) ? (h = c.left || 0, f = c.right || 0, g = c.top || 0, p = c.bottom || 0) : (h = c, f = c, g = c, p = c);
                            var m = e(t.boxes, "left"), v = e(t.boxes, "right"), b = e(t.boxes, "top"),
                                x = e(t.boxes, "bottom"), y = e(t.boxes, "chartArea");
                            n(m, !0), n(v, !1), n(b, !0), n(x, !1);
                            var k = a - h - f, w = o - g - p, M = k / 2, S = w / 2, C = (a - M) / (m.length + v.length),
                                D = (o - S) / (b.length + x.length), I = k, A = w, P = [];
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.plugins = {}, t.plugins = {
                    _plugins: [], _cacheId: 0, register: function (t) {
                        ...
                        for (i = 0; i < u; ++i) if (a = s[i], o = a.plugin, l = o[e], "function" == typeof l && (r = [t].concat(n || []), r.push(a.options), l.apply(o, r) === !1)) return !1;
                        return !0
                    }, descriptors: function (n) {
                        var i = n._plugins || (n._plugins = {});
                        if (i.id === this._cacheId) return i.descriptors;
                        var a = [], o = [], r = n && n.config || {}, l = t.defaults.global.plugins,
            ...
            e.exports = function (t) {
                ...
                function n(e) {
                    var n = i.getValueOrDefault, a = t.defaults.global, o = n(e.fontSize, a.defaultFontSize),
                        r = n(e.fontStyle, a.defaultFontStyle), l = n(e.fontFamily, a.defaultFontFamily);
                    return {size: o, style: r, family: l, font: i.fontString(o, r, l)}
                }
                ...
                t.defaults.scale = {
                    ...
                    calculateTickRotation: function () {
                        var t = this, e = t.ctx, a = t.options.ticks, o = n(a);
                        e.font = o.font;
                        var r = a.minRotation || 0;
                        if (t.options.display && t.isHorizontal()) for (var l, s, u = i.longestText(e, o.font, t.ticks, t.longestTextCache), d = u, c = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; d > c && r < a.maxRotation;) {
                            var h = i.toRadians(r);
                    ...
                    fit: function () {
                        var t = this, a = t.minSize = {width: 0, height: 0}, o = t.options, r = o.ticks,
                            l = o.scaleLabel, s = o.gridLines, u = o.display, d = t.isHorizontal(), c = n(r),
                            h = 1.5 * n(l).size, f = o.gridLines.tickMarkLength;
                        if (d ? a.width = t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : a.width = u && s.drawTicks ? f : 0, d ? a.height = u && s.drawTicks ? f : 0 : a.height = t.maxHeight, l.display && u && (d ? a.height += h : a.width += h), r.display && u) {
                            ...
                            if (d) {
                                ...
                                var k = t.ticks[0], w = e(t.ctx, k, c.font), M = t.ticks[t.ticks.length - 1],
                                    S = e(t.ctx, M, c.font);
                    ...
                    handleMargins: function () {
                        ...
                        // t.margins && (t.paddingLeft = Math.max(600, 0), t.paddingTop = Math.max(200, 0), t.paddingRight = Math.max(0, 0), t.paddingBottom = Math.max(200, 0))
                    },
                    afterFit: function () {
                    ...
                    draw: function (e) {
                        var a = this, o = a.options;
                        if (o.display) {
                            var r, l, s = a.ctx, u = t.defaults.global, d = o.ticks, c = o.gridLines, h = o.scaleLabel,
                                f = 0 !== a.labelRotation, g = d.autoSkip, p = a.isHorizontal();
                            d.maxTicksLimit && (l = d.maxTicksLimit);
                            var m = i.getValueOrDefault(d.fontColor, u.defaultFontColor), v = n(d),
                                b = c.drawTicks ? c.tickMarkLength : 0,
                                x = i.getValueOrDefault(h.fontColor, u.defaultFontColor), y = n(h),
                                k = i.toRadians(a.labelRotation), w = Math.cos(k), M = a.longestLabelWidth * w;
                            s.fillStyle = m;
                            var S = [];
                            if (p) {
                                if (r = !1, (M + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (r = 1 + Math.floor((M + d.autoSkipPadding) * a.ticks.length / (a.width - (a.paddingLeft + a.paddingRight)))), l && a.ticks.length > l) for (; !r || a.ticks.length / (r || 1) > l;) r || (r = 1), r += 1;
                                g || (r = !1)
                            }
                            ...
                            if (i.each(a.ticks, function (t, n) {
                                if (void 0 !== t && null !== t) {
                                    ...
                                    if ((!s || l) && void 0 !== t && null !== t) {
                                        ...
                                        if (p) {
                                            ...
                                            var B, W = "left" === o.position, N = d.padding;
                                ...
                                if (c.display && (s.save(), s.lineWidth = t.glWidth, s.strokeStyle = t.glColor, s.setLineDash && (s.setLineDash(t.glBorderDash), s.lineDashOffset = t.glBorderDashOffset), s.beginPath(), c.drawTicks && (s.moveTo(t.tx1, t.ty1), s.lineTo(t.tx2, t.ty2)), c.drawOnChartArea && (s.moveTo(t.x1, t.y1), s.lineTo(t.x2, t.y2)), s.stroke(), s.restore()), d.display) {
                                    ...
                                    var e = t.label;
                                    if (i.isArray(e)) for (var n = 0, a = 0; n < e.length; ++n) s.fillText("" + e[n], 0, a), a += 1.5 * v.size; else s.fillText(e, 0, 0);
                                    s.restore()
                                }
                            }), h.display) {
                                var P, _, T = 0;
                                if (p) P = a.left + (a.right - a.left) / 2, _ = "bottom" === o.position ? a.bottom - y.size / 2 : a.top + y.size / 2; else {
                            ...
                            if (c.drawBorder) {
                                ...
                                var R = a.left, L = a.right, V = a.top, O = a.bottom, z = i.aliasPixel(s.lineWidth);
                ...
                t.Ticks = {
                    generators: {
                        linear: function (t, n) {
                            ...
                            var r = Math.floor(n.min / i) * i, l = Math.ceil(n.max / i) * i;
                            ...
                            var i, a, o = [], r = e.getValueOrDefault,
                                l = r(t.min, Math.pow(10, Math.floor(e.log10(n.min)))), s = Math.floor(e.log10(n.max)),
            ...
            e.exports = function (t) {
                ...
                function a(e) {
                    var n = t.defaults.global, i = s.getValueOrDefault;
                    return {
                        xPadding: e.xPadding,
                        yPadding: e.yPadding,
                        xAlign: e.xAlign,
                ...
                function o(t, e) {
                    var n = t._chart.ctx, i = 2 * e.yPadding, a = 0, o = e.body, r = o.reduce(function (t, e) {
                ...
                t.defaults.global.tooltips = {
                    ...
                    initialize: function () {
                        ...
                        var n, u, d = this, c = d._options, h = d._model, f = d._model = a(c), g = d._active,
                            p = d._data, m = {xAlign: h.xAlign, yAlign: h.yAlign}, v = {x: h.x, y: h.y},
                        ...
                        if ("center" === h) l = g + m / 2, "left" === c ? (i = f, a = i - u, o = i, r = l + u, s = l - u) : (i = f + p, a = i + u, o = i, r = l - u, s = l + u); else if ("left" === c ? (a = f + d + u, i = a - u, o = a + u) : "right" === c ? (a = f + p - d - u, i = a - u, o = a + u) : (a = f + p / 2, i = a - u, o = a + u), "top" === h) r = g, l = r - u, s = r; else {
                            r = g + m, l = r + u, s = r;
                            var v = o;
                            o = i, i = v
                        }
                        ...
                        if (o.length) {
                            ...
                            var r = n.titleFontSize, l = n.titleSpacing;
                        ...
                        var o = n.bodyFontSize, r = n.bodySpacing, l = n.body;
                    ...
                    average: function (t) {
                        ...
                        var n, i, a, o = e.x, r = e.y, l = Number.POSITIVE_INFINITY;
                        for (i = 0, a = t.length; i < a; ++i) {
                            var u = t[i];
                            if (u && u.hasValue()) {
                                var d = u.getCenterPoint(), c = s.distanceBetweenPoints(e, d);
                                c < l && (l = c, n = u)
                            }
                        }
                        if (n) {
                ...
                n.elements.arc = {
                    ...
                    inLabelRange: function (t) {
                        ...
                        if (i) {
                            ...
                            for (; o > s;) o -= 2 * Math.PI;
                            for (; o < l;) o += 2 * Math.PI;
                            var u = o >= l && o <= s, d = r >= i.innerRadius && r <= i.outerRadius;
                            return u && d
                        }
                        return !1
            ...
            e.exports = function (t) {
                ...
                t.defaults.global.elements.line = {
                    ...
                    draw: function () {
                        var t, i, a, o, r = this, l = r._view, s = r._chart.ctx, u = l.spanGaps,
                            d = r._children.slice(), c = n.elements.line, h = -1;
            ...
            e.exports = function (t) {
                ...
                var i = t.helpers, a = t.defaults.global, o = a.defaultColor;
                a.elements.point = {
                    radius: 3,
                    pointStyle: "circle",
                    backgroundColor: o,
                    ...
                    inRange: function (t, e) {
                    ...
                    }, inLabelRange: e, inXRange: e, inYRange: n, getCenterPoint: function () {
                        var t = this._view;
                        return {x: t.x, y: t.y}
                    }, getArea: function () {
                        ...
                        var n = this._view, r = this._model, l = this._chart.ctx, s = n.pointStyle, u = n.radius,
                            d = n.x, c = n.y, h = t.helpers.color, f = 1.01, g = 0;
                ...
                i.elements.rectangle = {
                    ...
                    draw: function () {
                        ...
                        if (u.horizontal ? (e = u.base, n = u.x, i = u.y - u.height / 2, a = u.y + u.height / 2, o = n > e ? 1 : -1, r = 1, l = u.borderSkipped || "left") : (e = u.x - u.width / 2, n = u.x + u.width / 2, i = u.y, a = u.base, o = 1, r = a > i ? 1 : -1, l = u.borderSkipped || "bottom"), d) {
                            ...
                            d = d > c ? c : d;
                            var h = d / 2, f = e + ("left" !== l ? h * o : 0), g = n + ("right" !== l ? -h * o : 0),
                                p = i + ("top" !== l ? h * r : 0), m = a + ("bottom" !== l ? -h * r : 0);
                            f !== g && (i = p, a = m), p !== m && (e = f, n = g)
                        }
                        s.beginPath(), s.fillStyle = u.backgroundColor, s.strokeStyle = u.borderColor, s.lineWidth = d;
                        var v = [[e, a], [e, i], [n, i], [n, a]], b = ["bottom", "left", "top", "right"],
                            x = b.indexOf(l, 0);
                        x === -1 && (x = 0);
                        var y = t(0);
                        s.moveTo(y[0], y[1]);
            ...
            e.exports = function (t) {
                function e(t, e) {
                    var n = s.getStyle(t, e), i = n && n.match(/^(\d+)(\.\d+)?px$/);
                    return i ? Number(i[1]) : void 0
                }

                function n(t, n) {
                    var i = t.style, a = t.getAttribute("height"), o = t.getAttribute("width");
                    if (t._chartjs = {
                        initial: {
                            height: a,
                            width: o,
                ...
                function a(t, e) {
                    var n = u[t.type] || t.type, a = s.getRelativePosition(t, e);
                ...
                function r(t, e, n) {
                    var a = t._chartjs = {ticking: !1}, r = function () {
                ...
                return {
                    acquireContext: function (t, e) {
                        ...
                        var o = n._chartjs || (n._chartjs = {}), l = o.proxies || (o.proxies = {}),
                        ...
                        var a = n._chartjs || {}, o = a.proxies || {}, r = o[t.id + "_" + e];
            ...
            e.exports = function (t) {
                ...
                var s = t.defaults, u = t.helpers, d = {
                    dataset: function (t) {
                        var e = t.fill, n = t.chart, i = n.getDatasetMeta(e), a = i && n.isDatasetVisible(e),
                ...
                return {
                    id: "filler", afterDatasetsUpdate: function (o, r) {
                        var l, s, u, d, c = (o.data.datasets || []).length, h = r.propagate, f = [];
                        ...
                        var n = e.meta.$filler;
                        if (n) {
                            var i = n.el, a = i._view, o = i._children || [], r = n.mapper,
            ...
            e.exports = function (t) {
                ...
                var i = t.helpers, a = t.layoutService, o = i.noop;
                return t.defaults.global.legend = {
                    ...
                    initialize: function (t) {
                        ...
                        var n = this, a = n.options, o = a.labels, r = a.display, l = n.ctx, s = t.defaults.global,
                            u = i.getValueOrDefault, d = u(o.fontSize, s.defaultFontSize),
                            c = u(o.fontStyle, s.defaultFontStyle), h = u(o.fontFamily, s.defaultFontFamily),
                            f = i.fontString(d, c, h), g = n.legendHitBoxes = [], p = n.minSize, m = n.isHorizontal();
                        if (m ? (p.width = n.maxWidth, p.height = r ? 10 : 0) : (p.width = r ? 10 : 0, p.height = n.maxHeight), r) if (l.font = f, m) {
                            var v = n.lineWidths = [0], b = n.legendItems.length ? d + o.padding : 0;
                            l.textAlign = "left", l.textBaseline = "top", i.each(n.legendItems, function (t, i) {
                                var a = e(o, d), r = a + d / 2 + l.measureText(t.text).width;
                            ...
                            var x = o.padding, y = n.columnWidths = [], k = o.padding, w = 0, M = 0, S = d + x;
                            i.each(n.legendItems, function (t, n) {
                                var i = e(o, d), a = i + d / 2 + l.measureText(t.text).width;
                        ...
                        var n = this, a = n.options, o = a.labels, r = t.defaults.global, l = r.elements.line,
                            s = n.width, u = n.lineWidths;
                        if (a.display) {
                            var d, c = n.ctx, h = i.getValueOrDefault, f = h(o.fontColor, r.defaultFontColor),
                            ...
                            var b = e(o, g), x = n.legendHitBoxes, y = function (e, n, i) {
                                if (!(isNaN(b) || b <= 0)) {
                                    ...
                                    if (c.setLineDash && c.setLineDash(h(i.lineDash, l.borderDash)), a.labels && a.labels.usePointStyle) {
                                        var s = g * Math.SQRT2 / 2, u = s / Math.SQRT2, d = e + u, f = n + u;
                            ...
                            d = w ? {
                                ...
                                y: n.top + o.padding,
                                line: 0
                            } : {x: n.left + o.padding, y: n.top + o.padding, line: 0};
                            var M = g + o.padding;
                            i.each(n.legendItems, function (t, e) {
                                var i = c.measureText(t.text).width, a = b + g / 2 + i, r = d.x, l = d.y;
                    ...
                    id: "legend", beforeInit: function (t) {
                        ...
                        var o = e.options.legend, r = e.legend;
            ...
            e.exports = function (t) {
                ...
                var n = t.helpers, i = t.layoutService, a = n.noop;
                return t.defaults.global.title = {
                    ...
                    beforeFit: a,
                    fit: function () {
                        var e = this, i = n.getValueOrDefault, a = e.options, o = t.defaults.global, r = a.display,
                            l = i(a.fontSize, o.defaultFontSize), s = e.minSize;
                    ...
                    draw: function () {
                        var e = this, i = e.ctx, a = n.getValueOrDefault, o = e.options, r = t.defaults.global;
                        if (o.display) {
                            var l, s, u, d = a(o.fontSize, r.defaultFontSize), c = a(o.fontStyle, r.defaultFontStyle),
                                h = a(o.fontFamily, r.defaultFontFamily), f = n.fontString(d, c, h), g = 0, p = e.top,
                    ...
                    id: "title", beforeInit: function (t) {
                        ...
                        var o = a.options.title, r = a.titleBlock;
                ...
                var e = t.helpers, n = {position: "bottom"}, i = t.Scale.extend({
                    getLabels: function () {
                        ...
                        var e, n = this,
                            ...
                            a = n.isHorizontal(), o = (a ? n.width : n.height) / i;
            ...
            "use strict";
            e.exports = function (t) {
                var e = t.helpers, n = {position: "left", ticks: {callback: t.Ticks.formatters.linear}},
                    i = t.LinearScaleBase.extend({
                        determineDataLimits: function () {
                            ...
                            var n = this, i = n.options, a = n.chart, o = a.data, r = o.datasets, l = n.isHorizontal(),
                                s = 0, u = 1;
                            ...
                            if (void 0 === d && e.each(r, function (e, n) {
                                ...
                                e.each(r, function (o, r) {
                                    ...
                                    var u = c[s].positiveValues, d = c[s].negativeValues;
            ...
            e.exports = function (t) {
                ...
                t.LinearScaleBase = t.Scale.extend({
                    handleTickRangeOptions: function () {
                        ...
                        var n = this, i = n.options, a = i.ticks, o = n.getTickLimit();
                        o = Math.max(2, o);
                        var r = {
                            maxTicks: o,
                            min: a.min,
            ...
            "use strict";
            e.exports = function (t) {
                var e = t.helpers, n = {position: "left", ticks: {callback: t.Ticks.formatters.logarithmic}},
                    i = t.Scale.extend({
                        determineDataLimits: function () {
                            function t(t) {
                            ...
                            var n = this, i = n.options, a = i.ticks, o = n.chart, r = o.data, l = r.datasets,
                                s = e.getValueOrDefault, u = n.isHorizontal();
                            ...
                            var n = this, i = n.options, a = i.ticks, o = {min: a.min, max: a.max},
                            ...
                            var n, i, a, o = this, r = o.start, l = +o.getRightValue(t), s = o.options, u = s.ticks;
            ...
            e.exports = function (t) {
                ...
                function n(t) {
                    var e = t.options.pointLabels, n = f.getValueOrDefault(e.fontSize, g.defaultFontSize),
                        ...
                        a = f.getValueOrDefault(e.fontFamily, g.defaultFontFamily), o = f.fontString(n, i, a);
                ...
                function o(t) {
                    var o, r, l, s = n(t), u = Math.min(t.height / 2, t.width / 2),
                    ...
                    for (o = 0; o < h; o++) {
                        ...
                        var g = t.getIndexAngle(o), p = f.toDegrees(g) % 360, m = a(p, l.x, r.w, 0, 180),
                ...
                function s(t, e, n, i) {
                    if (f.isArray(e)) for (var a = n.y, o = 1.5 * i, r = 0; r < e.length; ++r) t.fillText(e[r], n.x, a), a += o; else t.fillText(e, n.x, n.y)
                }
                ...
                function d(t) {
                    var i = t.ctx, a = f.getValueOrDefault, o = t.options, r = o.angleLines, d = o.pointLabels;
                    i.lineWidth = r.lineWidth, i.strokeStyle = r.color;
                    var c = t.getDistanceFromCenterForValue(o.reverse ? t.min : t.max), h = n(t);
                    i.textBaseline = "top";
                    for (var p = e(t) - 1; p >= 0; p--) {
                        ...
                        if (d.display) {
                            var v = t.getPointPosition(p, c + 5), b = a(d.fontColor, g.defaultFontColor);
                ...
                function c(t, n, i, a) {
                    var o = t.ctx;
                    if (o.strokeStyle = f.getValueAtIndexOrDefault(n.color, a - 1), o.lineWidth = f.getValueAtIndexOrDefault(n.lineWidth, a - 1), t.options.gridLines.circular) o.beginPath(), o.arc(t.xCenter, t.yCenter, i, 0, 2 * Math.PI), o.closePath(), o.stroke(); else {
                        var r = e(t);
                        if (0 === r) return;
                        o.beginPath();
                ...
                var f = t.helpers, g = t.defaults.global, p = {
                    ...
                    setDimensions: function () {
                        ...
                        var i = f.min([t.height, t.width]), a = f.getValueOrDefault(n.fontSize, g.defaultFontSize);
                        ...
                        if (e.display) {
                            var o = t.ctx, r = a(i.fontSize, g.defaultFontSize), l = a(i.fontStyle, g.defaultFontStyle),
                                s = a(i.fontFamily, g.defaultFontFamily), u = f.fontString(r, l, s);
                            f.each(t.ticks, function (l, s) {
                                if (s > 0 || e.reverse) {
                                    var d = t.getDistanceFromCenterForValue(t.ticksAsNumbers[s]), h = t.yCenter - d;
            ...
            i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                ...
                function n(t, e, n, i) {
                    for (var a, o = Object.keys(l), r = o.length, s = o.indexOf(t); s < r; s++) {
                        a = o[s];
                        var u = l[a], d = u.steps && u.steps[u.steps.length - 1] || u.maxStep;
                ...
                function a(t, e, n, i) {
                    var a = l[n], o = a.size, r = Math.ceil((e - t) / o), s = 1, u = e - t;
                    if (a.steps) for (var d = a.steps.length, c = 0; c < d && r > i; c++) s = a.steps[c], r = Math.ceil(u / (o * s)); else for (; r > i && i > 0;) ++s, r = Math.ceil(u / (o * s));
                    return s
                }
                ...
                var u = t.Scale.extend({
                    initialize: function () {
                        ...
                        var t, n = this, i = n.options.time, a = Number.MAX_SAFE_INTEGER, o = Number.MIN_SAFE_INTEGER,
                            l = n.chart.data, s = {labels: [], datasets: []};
                        ...
                        var i, o, l = this, s = l.options.time, u = l.dataMin, d = l.dataMax;
                        if (s.min) {
                            var c = e(l, s.min);
                            s.round && c.round(s.round), i = c.valueOf()
                        }
                        s.max && (o = e(l, s.max).valueOf());
                        var h = l.getLabelCapacity(i || u), f = s.unit || n(s.minUnit, i || u, o || d, h);
                        ...
                        }, {min: u, max: d}), l.max = r.max(l.ticks), l.min = r.min(l.ticks)
                        ...
                        var i = t.format(this.displayFormat), a = this.options.ticks,
                        ...
                        var e = this, n = e.isHorizontal() ? e.width : e.height,
                            a = (t - (e.isHorizontal() ? e.left : e.top)) / n;
                        return i(e.min + a * (e.max - e.min))
                    }, getLabelWidth: function (e) {
                        var n = this, i = n.options.ticks, a = n.ctx.measureText(e).width,
                            o = Math.cos(r.toRadians(i.maxRotation)), l = Math.sin(r.toRadians(i.maxRotation)),
                        ...
                        var n = e.tickFormatFunction(i(t), 0, []), a = e.getLabelWidth(n),
                            o = e.isHorizontal() ? e.width : e.height, r = o / a;
                        return r
                    }
                });
